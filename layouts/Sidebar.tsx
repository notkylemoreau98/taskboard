...
// Need to be able to hide the sidebar

const Sidebar = () => {
  return (
    <section className="flex flex-col justify-between h-screen max-h-screen bg-[#2B2C37] border-r-2 border-[#3E3F4E] text-[#828FA3] px-6 py-9">
      <div>
        ...
        <div className="mt-10">
          ...
          <BoardTitle title="Christmas List" />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex items-center">
          ...
          <span className="pl-4">Hide Sidebar</span>
        </div>
      </div>
    </section>
  );
